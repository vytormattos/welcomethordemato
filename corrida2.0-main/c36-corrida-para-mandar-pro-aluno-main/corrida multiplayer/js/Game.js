class Game {
  ...
  handleElements() {
    ...
    this.resetTitle.html("APERTE AQUI PRA PERDE DINHEIRO");
    this.resetTitle.class("resetText");
    this.resetTitle.position(width / 2 + 200, 40);

    this.resetButton.class("resetButton");
    this.resetButton.position(width / +230, 100);
  ...
  showRank() {
    swal({
      title: `muito bom soldado!${"\n"}Rank${"\n"}${player.rank}`,
      text: "boa soldado você destruiu seu adversario isso é o verdadeiro esporte",
  ...
  showgameOver() {
    swal({
      title: "MUITO FEIO SOLDADO!,FIM DE JOGO!",
      text: "VOCE PERDEU SEU LIXO  VOCE ESTA PROIBIDO DE JOGAR MEU JOGO",
      imageUrl: "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
      imageSize: "100x100",
      confirmButtonText: "SUMA SEU VERME"
